...
//entityœ‡µ±”⁄pojo(mybaitis≥∆∫Ù)
public class Address implements Serializable {

	private static final long serialVersionUID = -2360563110057065406L;
	...
	public Address(Integer id, Integer uid, String recvName, String recvProvince, String recvCity, String recvArea,
			String recvDistrict, String recvAddress, String recvPhone, String recvTel, String recvZip, String tag,
	...
	public String toString() {
		return "Address [id=" + id + ", uid=" + uid + ", recvName=" + recvName + ", recvProvince=" + recvProvince
				...
				+ recvZip + ", tag=" + tag + ", isDefault=" + isDefault + ", createdUser=" + createdUser
